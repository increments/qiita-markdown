    ...
    module Filters
      class SyntaxHighlight < HTML::Pipeline::Filter
        ...
        class Highlighter
          ...
          # @return [String, nil] The filename detected at Qiita::Markdown::Filters::CodeBlock (e.g. `"config.ru"`)
          def filename
            @node["filename"]
          end
          ...
          # @return [String] The language name detected at Qiita::Markdown::Filters::CodeBlock (e.g. `"ruby"`)
          def language
            @node["lang"]
          end
